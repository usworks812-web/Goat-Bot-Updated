...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "gay") || (event.body.toLowerCase() == "Gay")) {
     return api.sendMessage("আরেহ ওই চরিত্রের লোক জামি,হাসান,কাশিফ, এগুলো আর লিখো নাহ দেস ।", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Rudro") || (event.body.toLowerCase() == "Rudro bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "rudro")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Rudro ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Rudra/Ery.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https:nai \nতার সাতে যোগা যোগ করবেন WhatsApp :- +০১৫৮৬***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Rudro ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রুদ্র আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Rudro ッ❤️ তাকে সবাই উল্লাস নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@hs hasan") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা ওইটা আমার বস Ery Nocturne এর চাকর 😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Hasan") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রুদ্র এর চাকর এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "mim") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রুদ্র এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "noob ") || (event.body.toLowerCase() == "hasan")) {
     return api.sendMessage(" প্রকৃত নুব হচ্ছে এডমিন হাসান যে কিনা রুদ্র এর চাকর😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>Ery Nocturne", threadID);
   };

   if ((event.body.toLowerCase() == "Bot er bacca") || (event.body.toLowerCase() == "Bot er baccha")) {
   ...
   if ((event.body.toLowerCase() == "ami Rudro") || (event.body.toLowerCase() == "kire")) {
